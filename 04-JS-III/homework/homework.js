...
function breakStatement(numero) {
  ...
  for(var i = 0; i < 10; i++){
    ...
    if(val === i){
      ...
      other2NewArray.push(val);
    }
  }
  if(i < 10){
    return "Se interrumpió la ejecución";
  }else{
    return other2NewArray;
  }
}
